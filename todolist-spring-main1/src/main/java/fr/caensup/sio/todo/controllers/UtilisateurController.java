...
public class UtilisateurController {
	...
	@PostMapping("/login")
	public RedirectView loginSubmitAction(@RequestParam String login, String password, HttpSession session) throws InvalidUserException {
		Utilisateur user = userService.findByLoginAndPassword(login, password);
